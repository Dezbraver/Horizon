...
public class ElfsFilesExtractor extends MemoryPluginBase {
    ...
    public void runPlugin() {
        ...
        InputStream is = null;
        try {
            is = getV3PluginOutput("linux.elfs.Elfs", null);
        } catch (IOException e) {
        ...
        for(Object opid: pidset) {
            String header = "Start\tEnd\tFile Path\n";
            String pid = opid.toString();
            String name = pid + "_Elfs.txt";
