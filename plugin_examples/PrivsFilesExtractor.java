...
public class PrivsFilesExtractor extends MemoryPluginBase {
    ...
    public void runPlugin() {
        ...
        InputStream is = null;
        try {
            is = getV3PluginOutput("windows.privileges.Privs", null);
        } catch (IOException e) {
        ...
        for(Object opid: pidset) {
            String header = "Value\tPrivilege\tAttributes\tDescription\n";
            String pid = opid.toString();
            String name = pid + "_Privs.txt";
