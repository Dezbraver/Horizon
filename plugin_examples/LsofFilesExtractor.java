...
public class LsofFilesExtractor extends MemoryPluginBase {
    ...
    public void runPlugin() {
        ...
        InputStream is = null;
        try {
            is = getV3PluginOutput("linux.lsof.Lsof", null);
        } catch (IOException e) {
        ...
        for(Object opid: pidset) {
            String header = "FD\tPath\n";
            String pid = opid.toString();
            String name = pid + "_Memory_Maps_Lsof.txt";
